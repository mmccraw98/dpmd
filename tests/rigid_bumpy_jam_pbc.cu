...
int main(int argc, char** argv) {
    ...
    om.set_extra_final_fields({"pe_total", "box_size", "packing_fraction", "n_contacts_total", "friction_coeff", "pair_vertex_contacts", "hessian_xx", "hessian_xy", "hessian_yx", "hessian_yy", "hessian_xt", "hessian_tx", "hessian_yt", "hessian_ty", "hessian_tt", "pair_forces", "pair_ids"});
    om.initialize();
